                ...
                <table class="table table-striped">
                    ...
                    <form action="" method="post">
                        ...
                        <?php foreach ($cartObj->getAll() as $row) {
                            $vatValue = $row->cart_price * 0.2;
                            $TOTAL += $row->quantity * ($row->cart_price + $vatValue);
                        ?>
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="text-align: right;padding-right: 20px;font-weight: 500 !important;">Total (incl. VAT) - £<?= number_format($TOTAL, 2) ?></td>
                        </tr>
                    </form>
