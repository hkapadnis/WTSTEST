...
<div class="container pt-30 pb-50 page-block">
		...
		<form class="form-horizontal form-light" id="form" method="post" action="">
					...
					<div class="panel-heading">PLEASE LOGIN TO YOUR ACCOUNT HERE <?php if( isset($_GET['new-account-registered']) == 'true') {
						...
						<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										...
										value="<?php if( isset($_GET['email']) != '') { echo $_GET['email']; } else ""?>">
									</div>
								</div>
